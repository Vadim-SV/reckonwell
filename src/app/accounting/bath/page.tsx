...
import { CityTrustBadges, CityFounderBlock } from '../../components/CityPageTrustElements';

const cityName = 'Bath';
const citySlug = 'bath';
const cityDesc = 'a UNESCO World Heritage city with a thriving tourism, hospitality, and professional services economy';
const businessCount = '12,000+';
const coords = { lat: 51.3811, lng: -2.3590 };
...
const faqs = [
  ...
  { q: `I run a hospitality or tourism business in ${cityName} — which service suits me?`, a: `Many Bath hospitality and tourism operators run as sole traders or limited companies with seasonal income. Our self-employed package starts at £80/month and includes year-round tax monitoring to manage fluctuating earnings. If you operate through a limited company, our company accounting package starts at £150/month.` },
];
