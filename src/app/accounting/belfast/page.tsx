...
const faqs = [
  ...
  { q: 'Are there any Northern Ireland-specific tax considerations?', a: 'Northern Ireland businesses follow UK tax rules, including UK income tax rates. However, there are specific considerations around cross-border trade with the Republic of Ireland and potential VAT implications. We factor all of this into our advice for Belfast-based clients.' },
];
