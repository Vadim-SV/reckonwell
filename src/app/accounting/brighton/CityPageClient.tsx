...
const citySlug = 'brighton';

const nearbyCities = [
  { name: 'London', href: '/accounting/london' },
];
const cityDesc = 'a vibrant South East city known for its creative, digital, and freelance economy';
const coords = { lat: 50.8225, lng: -0.1372 };
...
const faqs = [
  ...
  { q: `I'm a freelancer or creative professional in ${cityName} — which service is right for me?`, a: `Most Brighton freelancers and creatives operate as sole traders and need self-employed accounting. If your income is over £50k, you'll also need MTD compliance from April 2026. Our self-employed package starts at £80/month and covers both.` },
];
