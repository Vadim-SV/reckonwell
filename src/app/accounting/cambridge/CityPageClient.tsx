...
const citySlug = 'cambridge';

const nearbyCities = [
  { name: 'London', href: '/accounting/london' },
  { name: 'Oxford', href: '/accounting/oxford' },
];
const cityDesc = 'one of the UK\'s fastest-growing tech and innovation hubs';
const coords = { lat: 52.2053, lng: 0.1218 };
...
const faqs = [
  ...
  { q: `Do you have experience with Cambridge tech and life sciences businesses?`, a: `Yes. We work with a number of Cambridge-based startups, spin-outs, and scale-ups — including businesses eligible for R&D tax relief. We understand the specific compliance needs of innovation-led companies.` },
];
