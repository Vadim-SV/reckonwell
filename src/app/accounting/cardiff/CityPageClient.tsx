...
const cityName = 'Cardiff';
const citySlug = 'cardiff';

const nearbyCities = [
  { name: 'Bristol', href: '/accounting/bristol' },
  { name: 'Bath', href: '/accounting/bath' },
];
const cityDesc = 'the capital of Wales and a growing hub for business and finance';
const coords = { lat: 51.4816, lng: -3.1791 };
...
const faqs = [
  ...
  { q: `Are there any Wales-specific tax considerations for Cardiff businesses?`, a: `Welsh taxpayers pay Welsh rates of income tax, which are currently set at the same level as England. We factor this into all self-employed and director salary planning for Cardiff-based clients.` },
];
