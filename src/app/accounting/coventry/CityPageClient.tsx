...
const cityName = 'Coventry';
const citySlug = 'coventry';

const nearbyCities = [
  { name: 'Birmingham', href: '/accounting/birmingham' },
  { name: 'Leicester', href: '/accounting/leicester' },
];
const cityDesc = 'a dynamic West Midlands city known for its automotive, engineering, and growing tech sectors';
const coords = { lat: 52.4068, lng: -1.5197 };
...
const faqs = [
  ...
  { q: `Do you work with automotive or engineering businesses in ${cityName}?`, a: `Yes. We have experience with engineering and manufacturing businesses, including R&D tax relief claims for qualifying innovation activities. Coventry's automotive and tech sectors often have significant R&D expenditure that qualifies for relief.` },
];
