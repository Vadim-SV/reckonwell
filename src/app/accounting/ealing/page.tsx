...
const boroughName = 'Ealing';
const boroughSlug = 'ealing';
const boroughDesc = 'home to established retail high streets, Ealing Studios\' film and media presence, and a growing small business base';
...
const faqs = [
  ...
  { q: `I work in film or media production connected to Ealing Studios — what accounting do I need?`, a: "Film and media production professionals in Ealing typically need self-employed or limited company accounting, and may qualify for R&D tax relief on qualifying creative development work. We handle all of this under one monthly fee." },
];
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to Ealing Broadway for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell serves businesses across {boroughDesc}. From film and media professionals connected to Ealing Studios to retail businesses on the high street and a growing community of small business owners — transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        {/* Working With Ealing Businesses */}
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Ealing has a well-established retail and small business base along its high streets, alongside a distinct media and creative presence anchored by Ealing Studios — one of the UK's oldest working film studios, which continues to attract production companies, freelance creatives, and post-production businesses to the area. The borough also has a significant professional services and financial advisory community, particularly around Ealing Broadway. The compliance picture spans film and media freelancers and sole traders, retail and hospitality VAT, and standard limited company accounting for the professional services businesses — a broad mix that benefits from a flexible, remote accounting practice rather than a narrowly specialised local firm.</p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Reckonwell is a fully remote practice — there's no office near Ealing Broadway or the Studios. That means no trip across West London for a meeting, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For Ealing businesses that want consistent, transparent accounting support, that tends to be a better fit than a traditional local firm.</p>
            </div>
          </div>
        </section>
