...
const nearbyCities = [
  { name: 'Glasgow', href: '/accounting/glasgow' },
];
const cityDesc = 'Scotland\'s capital and financial services hub';
const businessCount = '35,000+';
...
const faqs = [
  ...
  { q: 'Do Scottish businesses have different tax rules?', a: 'Scottish income tax rates differ from the rest of the UK for some bands. We account for Scottish rate taxpayers in all our Self Assessment filings automatically.' },
