...
const citySlug = 'glasgow';

const nearbyCities = [
  { name: 'Edinburgh', href: '/accounting/edinburgh' },
];
const cityDesc = 'Scotland\'s largest city and a major financial and commercial centre';
const coords = { lat: 55.8642, lng: -4.2518 };
...
const faqs = [
  ...
  { q: `Does Scottish income tax affect my accounting?`, a: `Yes. Scottish taxpayers pay different income tax rates from the rest of the UK. We factor Scottish income tax bands into all self-employed and director salary planning for Glasgow-based clients.` },
