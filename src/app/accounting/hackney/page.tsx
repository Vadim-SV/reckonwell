...
const boroughName = 'Hackney';
const boroughSlug = 'hackney';
const boroughDesc = 'home to the "Silicon Roundabout" tech cluster around Old Street, creative industries, fashion, and independent retail';
...
const faqs = [
  ...
  { q: `I'm a tech founder in the Silicon Roundabout area — what accounting do I need?`, a: "Tech founders in Hackney typically need limited company accounting, and may qualify for R&D tax relief on qualifying development work. We handle both under one monthly fee, with R&D claims from £850 one-off." },
];
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to Hackney Central for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell serves businesses across {boroughDesc}. From tech startups in the Silicon Roundabout cluster to creative studios, fashion labels, and independent retailers — transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        {/* Working With Hackney Businesses */}
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Hackney is one of London's most entrepreneurially active boroughs. The western edge — Shoreditch, Hoxton, and the Old Street corridor — is part of Silicon Roundabout, with a dense concentration of tech startups, digital agencies, and SaaS businesses. Dalston and Stoke Newington have a strong independent retail, food, and creative-economy character. Hackney Wick has become a significant arts and creative-industries cluster. The compliance picture is dominated by early-stage limited companies and self-employed creatives and tech founders: R&D tax relief eligibility is common for the tech businesses, payroll set-up as teams grow is a recurring need, and the jump from sole trader to limited company structure happens frequently as businesses scale past the VAT threshold.</p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Reckonwell is a fully remote practice — there's no office near Hackney Central or Shoreditch. That means no trip across the borough for a meeting, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For fast-moving Hackney businesses, that kind of responsiveness tends to be a better fit than a traditional local firm.</p>
            </div>
          </div>
        </section>
