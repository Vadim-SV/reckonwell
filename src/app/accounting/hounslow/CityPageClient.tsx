...
const boroughName = 'Hounslow';
const boroughSlug = 'hounslow';
const boroughDesc = 'home to the Heathrow corridor\'s logistics, aviation, and hospitality businesses, plus trade and import-export firms';
...
const faqs = [
  ...
  { q: `I run a logistics or import-export business near Heathrow — what accounting do I need?`, a: "Logistics, aviation, and trade businesses in Hounslow typically need limited company accounting, VAT returns, and payroll. We handle all of this under one monthly fee with transparent, fixed pricing." },
];
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>100% remote — no trip to Hounslow town centre for a meeting.</p>
