...
const boroughName = 'Islington';
const boroughSlug = 'islington';
const boroughDesc = 'a borough known for media and creative agencies, tech businesses near the Old Street corridor, and a strong professional services base';
...
const faqs = [
  ...
  { q: `I run a tech startup near Old Street — could I qualify for R&D tax relief?`, a: "Many tech businesses near the Old Street corridor qualify for R&D tax relief on qualifying innovation and development work. We assess eligibility and handle the full claim from £850 one-off." },
];
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to Angel for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell serves businesses across {boroughDesc}. From creative agencies and media companies to tech businesses near the Old Street corridor — transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        {/* Working With Islington Businesses */}
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>
                Islington's Angel and Upper Street host a dense cluster of digital agencies, media businesses, and professional-services SMEs, with a genuinely high concentration of small owner-managed businesses rather than corporate headquarters. The borough also borders the Old Street corridor, which means a significant number of Islington-registered businesses are in the tech and SaaS space. The compliance picture here is mostly limited company and self-employed accounting for small, fast-moving service businesses — straightforward in structure but requiring consistent attention to VAT registration thresholds, payroll as teams grow, and the occasional R&D claim for the more technical businesses.
              </p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>
                Reckonwell is a fully remote practice — there's no office near Angel or Upper Street. That means no trip across Islington for a meeting, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For owner-managed businesses that move quickly and don't want to spend time on admin, that tends to be a better fit than a traditional local firm.
              </p>
            </div>
          </div>
        </section>
