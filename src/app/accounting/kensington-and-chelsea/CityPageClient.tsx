...
const faqs = [
  ...
  { q: `I run a luxury retail or hospitality business on King's Road — what do I need?`, a: "Luxury retail and hospitality businesses in Kensington and Chelsea typically need limited company accounting, VAT returns, and payroll. We handle all of this under one monthly fee with transparent, fixed pricing." },
];
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>100% remote — no trip to King's Road for a meeting.</p>
        ...
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-display mb-6" style={{ fontSize: 'clamp(28px,4vw,48px)', fontWeight: 400, color: 'var(--foreground)' }}>See your exact accounting price</h2>
