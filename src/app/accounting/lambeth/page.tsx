...
const boroughSlug = 'lambeth';
const boroughDesc = 'home to the Vauxhall and Waterloo business district, creative industries, and the South Bank\'s cultural and hospitality sector';
...
const faqs = [
  ...
  { q: `I run a hospitality or cultural business on the South Bank — what do I need?`, a: "Hospitality and cultural businesses in Lambeth typically need self-employed or limited company accounting, VAT returns, and payroll if you have staff. We handle all of this under one monthly fee." },
];
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to Waterloo for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell serves businesses across {boroughDesc}. From professional services firms in Vauxhall and Waterloo to creative industries and hospitality businesses along the South Bank — transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        {/* Working With Lambeth Businesses */}
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Lambeth spans a wide range of business types. Vauxhall and Waterloo form a significant professional services and office district, with a mix of consultancies, media businesses, and government-adjacent organisations. The South Bank — Waterloo, Southbank, and the areas around the cultural venues — has a dense hospitality and creative-economy character, with restaurants, bars, and creative businesses benefiting from the tourist and office-worker footfall. Brixton has a strong independent retail and food scene, with a growing number of small creative and digital businesses. The compliance picture spans professional-services limited company accounts, VAT-heavy hospitality, and self-employed accounting for the creative and freelance community.</p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Reckonwell is a fully remote practice — there's no office near Waterloo or Brixton. That means no trip across Lambeth for a meeting, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For Lambeth businesses that want straightforward, transparent accounting support, that tends to be a better fit than a traditional local firm.</p>
            </div>
          </div>
        </section>
