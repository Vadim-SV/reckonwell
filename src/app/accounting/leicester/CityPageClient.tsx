...
const cityName = 'Leicester';
const citySlug = 'leicester';

const nearbyCities = [
  { name: 'Nottingham', href: '/accounting/nottingham' },
  { name: 'Birmingham', href: '/accounting/birmingham' },
  { name: 'Coventry', href: '/accounting/coventry' },
];
const cityDesc = 'a diverse and growing East Midlands city with strong retail, textile, and professional services sectors';
const coords = { lat: 52.6369, lng: -1.1398 };
...
const faqs = [
  ...
  { q: `I run a retail or e-commerce business in ${cityName} — can you help?`, a: `Yes. We work with many retail and e-commerce businesses, handling VAT returns, stock accounting, and self-assessment or corporation tax filings. Our pricing is transparent and based on your business size.` },
];
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        telephone: '', areaServed: { '@type': 'City', name: cityName },
