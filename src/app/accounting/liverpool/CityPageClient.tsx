...
const citySlug = 'liverpool';

const nearbyCities = [
  { name: 'Manchester', href: '/accounting/manchester' },
  { name: 'Sheffield', href: '/accounting/sheffield' },
];
const cityDesc = 'a major northern city with a thriving business community';
const coords = { lat: 53.4084, lng: -2.9916 };
...
const faqs = [
  ...
  { q: `I run a hospitality or retail business in ${cityName} — can you help?`, a: `Absolutely. We work with hospitality, retail, and creative businesses across Liverpool. We understand the cash flow and VAT complexities that come with these sectors.` },
];
