...
const cityName = 'Moorgate';
const citySlug = 'moorgate';
const cityDesc = 'the northern edge of the City of London — a dense cluster of financial and professional services firms';

const nearbyCities = [
  { name: 'City of London', href: '/accounting/city-of-london' },
  { name: 'Old Street', href: '/accounting/old-street' },
  { name: 'Islington', href: '/accounting/islington' },
  { name: 'Southwark', href: '/accounting/southwark' },
];

const faqs = [
  { q: `Do you work with businesses based in ${cityName}?`, a: `Yes. We work with professional services firms and businesses across ${cityName} and the wider City of London area remotely. All onboarding, filing, and communication is handled online — no need to visit an office.` },
  ...
  { q: 'We work with financial services clients — do we need to worry about IR35?', a: 'IR35 and off-payroll working rules are a common consideration for consultancies and advisory firms in Moorgate, particularly those whose clients are in financial services. We assess your contracts and advise on the correct treatment as part of our limited company accounting service.' },
];

const services = [
  { title: 'Limited Company Accounting', desc: 'CT600, statutory accounts, Companies House filings, and payroll for professional services firms.', href: '/limited-company-accounting', price: 'From £150/mo' },
  ...
  { title: 'VAT Returns', desc: 'Quarterly VAT returns, MTD for VAT compliance, and VAT registration for growing businesses.', href: '/vat-returns', price: 'From £80/mo' },
...
export default function MoorgateClient() {
  ...
  return (
    <>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to London Wall for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell works with professional services firms and businesses in {cityDesc}. Transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="font-display mb-12" style={{ fontSize: 'clamp(28px,4vw,48px)', fontWeight: 400, color: 'var(--foreground)' }}>
              Why {cityName} firms work with us
            </h2>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>
                Moorgate sits on the northern edge of the City of London, and the business mix reflects that: asset managers, insurance firms, legal practices, and corporate advisory businesses are clustered along London Wall and Moorgate itself. Smaller consultancies and advisory firms based here often need standard limited company accounting, VAT returns, and payroll, but the financial-services client base many of them serve brings additional complexity. IR35 and off-payroll working rules come up regularly — particularly for contractors and consultants whose end clients are regulated financial institutions — and getting the employment status determination right matters more here than in most other parts of London.
              </p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>
                Reckonwell is a fully remote practice — there's no office near Moorgate or London Wall. That means no scheduling around City traffic, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For professional services firms that bill by the hour, that kind of efficiency tends to resonate.
              </p>
            </div>
          </div>
        </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        name: 'Reckonwell',
        description: `Accounting and bookkeeping services for businesses in ${cityName}, London. Limited company, VAT, payroll, and IR35 advice.`,
