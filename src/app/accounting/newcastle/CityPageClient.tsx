...
const cityName = 'Newcastle';
const citySlug = 'newcastle';

const nearbyCities = [
  { name: 'York', href: '/accounting/york' },
...
const faqs = [
  ...
  { q: `Do you support Newcastle's digital and tech startup scene?`, a: `Yes. Newcastle has a thriving digital and tech community, and many startups qualify for R&D tax relief. We also support early-stage limited companies with affordable compliance packages from £150/month.` },
];
