...
const boroughName = 'Newham';
const boroughSlug = 'newham';
const boroughDesc = 'home to Stratford and the Queen Elizabeth Olympic Park\'s ongoing regeneration, ExCeL London\'s events and exhibition economy, and a growing and diverse SME base';
...
const faqs = [
  ...
  { q: `I run a business connected to ExCeL London or the Stratford regeneration area — what do I need?`, a: "Events, exhibition, and hospitality businesses in Newham typically need limited company accounting, VAT returns, and payroll. We handle all of this under one monthly fee with transparent, fixed pricing." },
];
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to Stratford for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell serves businesses across {boroughDesc}. From events and exhibition businesses at ExCeL London to new businesses in the Stratford regeneration zone and a diverse community of SMEs — transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        {/* Working With Newham Businesses */}
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Newham has undergone significant regeneration since the 2012 Olympics, and the Stratford area in particular has become a major commercial and retail destination. The Queen Elizabeth Olympic Park continues to attract new businesses and cultural organisations, and the International Quarter development has brought corporate office tenants to the area. ExCeL London, on the Royal Docks, is one of the UK's largest exhibition and events venues, generating significant trade for hospitality, events-services, and logistics businesses in the surrounding area. Across the borough, a diverse and growing SME base reflects Newham's changing character — a mix of established trade businesses, newer creative and digital SMEs, and the hospitality and retail operators that serve the regenerated areas.</p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Reckonwell is a fully remote practice — there's no office near Stratford or the Royal Docks. That means no trip across East London for a meeting, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For Newham businesses that want consistent, transparent accounting support, that tends to be a better fit than a traditional local firm.</p>
            </div>
          </div>
        </section>
