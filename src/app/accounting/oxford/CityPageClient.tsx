...
const cityName = 'Oxford';
const citySlug = 'oxford';
...
const cityDesc = 'a world-renowned centre for education, research, and business';
const coords = { lat: 51.7520, lng: -1.2577 };
...
const faqs = [
  ...
  { q: `Do you support Oxford university spin-outs and research businesses?`, a: `Yes. We regularly work with university spin-outs, research commercialisation businesses, and knowledge-intensive companies in Oxford — many of which qualify for R&D tax relief.` },
];
