...
const nearbyCities = [
  ...
  { name: 'Manchester', href: '/accounting/manchester' },
  { name: 'Nottingham', href: '/accounting/nottingham' },
];
const cityDesc = 'a dynamic northern city with a strong manufacturing and creative economy';
const coords = { lat: 53.3811, lng: -1.4701 };
...
const faqs = [
  ...
  { q: `Do you work with manufacturing and engineering businesses in ${cityName}?`, a: `Yes. Sheffield has a strong manufacturing and engineering heritage, and many of these businesses qualify for R&D tax relief. We have experience preparing R&D claims for engineering and advanced manufacturing companies.` },
];
