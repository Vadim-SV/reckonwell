...
const faqs = [
  ...
  { q: `I work in fintech near Canary Wharf — what accounting do I need?`, a: "Fintech and financial services businesses in Canary Wharf typically need limited company accounting, VAT returns, and payroll. Many also qualify for R&D tax relief on qualifying software development. We handle all of this under one monthly fee." },
];
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>100% remote — no trip to Canary Wharf for a meeting.</p>
