...
const boroughName = 'Wandsworth';
const boroughSlug = 'wandsworth';
const boroughDesc = 'home to the Battersea Power Station redevelopment and its new business tenants, alongside Clapham\'s retail and hospitality high streets';
...
const faqs = [
  ...
  { q: `I have a retail or hospitality business in Clapham — what accounting do I need?`, a: "Retail and hospitality businesses in Clapham and Wandsworth typically need self-employed or limited company accounting, VAT returns, and payroll. We handle all of this under one monthly fee." },
];
  ...
  return (
    <>
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>
              100% remote — no trip to Clapham for a meeting.
            </p>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Reckonwell serves businesses across {boroughDesc}. From new business tenants at the Battersea Power Station development to retail and hospitality operators on Clapham's high streets — transparent pricing, no hidden fees, and a named accountant who knows your business.
            </p>
        ...
        {/* Working With Wandsworth Businesses */}
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Wandsworth has a varied business character. The Battersea Power Station redevelopment has brought a significant new commercial district to the borough's northern edge, with retail, hospitality, and office tenants establishing themselves in the regenerated space. Clapham — particularly Clapham High Street and the Old Town — has a strong independent retail and hospitality character, with a mix of restaurants, bars, and independent shops. Tooting and Balham have their own distinct retail and food scenes. The compliance picture spans new businesses in the Battersea development, established retail and hospitality operators across the borough's high streets, and a professional services and self-employed community that has grown as the area has become increasingly popular with London workers.</p>
              <p className="font-ui" style={{ color: 'var(--muted)', fontSize: '16px', lineHeight: 1.8 }}>Reckonwell is a fully remote practice — there's no office near Clapham or Battersea. That means no trip across South London for a meeting, no waiting rooms. Onboarding takes 48 hours, everything runs through Xero, QuickBooks, or FreeAgent, and your accountant is reachable directly. For Wandsworth businesses that want consistent, transparent accounting support, that tends to be a better fit than a traditional local firm.</p>
            </div>
          </div>
        </section>
