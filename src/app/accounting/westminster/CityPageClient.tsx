...
const boroughName = 'Westminster';
const boroughSlug = 'westminster';
const boroughDesc = 'the seat of government and home to the West End, Victoria, and Whitehall business districts';
...
const faqs = [
  ...
  { q: `I run a consultancy firm in Whitehall — what accounting do I need?`, a: 'Professional services and consultancy firms in Westminster typically need limited company accounting, VAT returns, and payroll if you have staff. We handle all of this under one monthly fee.' },
];
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <p className="font-ui font-semibold mb-6" style={{ color: 'var(--primary)', fontSize: '16px' }}>100% remote — no trip to Victoria for a meeting.</p>
