        ...
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="font-display mb-10" style={{ fontSize: 'clamp(26px,3.5vw,42px)', fontWeight: 400, color: 'var(--foreground)' }}>
              Bookkeeping pricing for Birmingham businesses
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              {[
                { tier: 'Foundation', price: '£150', unit: '/month', desc: 'Up to 100 transactions/month. Ideal for small Birmingham businesses and sole traders.', features: ['Monthly bank reconciliation', 'Income & expense categorisation', 'Monthly P&L report', 'Xero or QuickBooks included'] },
                { tier: 'Growth', price: '£250', unit: '/month', desc: 'Up to 300 transactions/month. For growing Birmingham businesses with more complexity.', features: ['Everything in Foundation', 'Accounts payable management', 'Accounts receivable chasing', 'Monthly management accounts'] },
                { tier: 'Scale', price: '£400', unit: '/month', desc: 'Unlimited transactions. For established Birmingham businesses needing full finance support.', features: ['Everything in Growth', 'Multi-currency support', 'CIS compliance (if applicable)', 'Quarterly business review'] },
              ].map((tier, i) => (
