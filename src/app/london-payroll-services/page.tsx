        ...
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="font-display mb-10" style={{ fontSize: 'clamp(26px,3.5vw,42px)', fontWeight: 400, color: 'var(--foreground)' }}>
              Simple, per-employee pricing for London
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              {[
                { range: '1–5 employees', price: '£20–40', unit: '/employee/month', desc: 'Small London team payroll with full RTI and auto-enrolment' },
                { range: '6–20 employees', price: '£30–45', unit: '/employee/month', desc: 'Growing London team with complex pay structures and benefits' },
                { range: '20+ employees', price: '£40–50', unit: '/employee/month', desc: 'Large London team payroll with dedicated payroll manager' },
              ].map((tier, i) => (
            ...
            <p className="font-ui text-xs" style={{ color: 'var(--muted)' }}>No London surcharge. Same pricing nationwide. Use the quotation calculator for your exact total.</p>
          </div>
        </section>
