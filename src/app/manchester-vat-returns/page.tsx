...
const faqs = [
  { q: 'When does my Manchester business need to register for VAT?', a: 'You must register for VAT when your taxable turnover exceeds £90,000 in any rolling 12-month period. Many Manchester businesses in the tech and creative sectors register voluntarily to reclaim input VAT on costs.' },
  { q: 'What is Making Tax Digital for VAT and does it apply to me?', a: 'MTD for VAT requires all VAT-registered businesses to keep digital records and submit returns using HMRC-compatible software. We handle all MTD compliance using Xero or QuickBooks — no technical knowledge required.' },
  { q: 'Is the Flat Rate Scheme right for my Manchester business?', a: 'The Flat Rate Scheme can save money if your actual VAT costs are lower than the flat rate for your sector. Manchester\'s digital and creative industries often benefit. We analyse your situation and advise on the most tax-efficient scheme.' },
  { q: 'Can you handle VAT for Manchester businesses with international clients?', a: 'Yes. Manchester\'s growing tech and media sector often involves cross-border services. We advise on place of supply rules, reverse charge VAT, and EU OSS registration for digital service sellers.' },
  ...
  { q: 'Do you handle VAT for Manchester-based e-commerce businesses?', a: 'Yes. We manage VAT for e-commerce businesses including marketplace VAT obligations, distance selling thresholds, and import VAT on goods from outside the UK.' },
];

const schema = {
  '@context': 'https://schema.org',
  '@type': 'LocalBusiness',
  name: 'Reckonwell — Manchester VAT Returns',
  description: 'VAT return preparation and filing for Manchester businesses. MTD-compliant, flat rate scheme analysis, and VAT registration.',
...
export default function ManchesterVatReturnsPage() {
      ...
      <main style={{ backgroundColor: 'var(--background)', minHeight: '100vh', paddingTop: '80px' }}>
        ...
        <section className="px-6 md:px-10 py-16 md:py-24" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            <p className="section-label mb-4">VAT Returns · Manchester</p>
            <h1 className="font-display mb-6" style={{ fontSize: 'clamp(36px,6vw,72px)', fontWeight: 400, color: 'var(--foreground)', lineHeight: 1.05, letterSpacing: '-0.02em' }}>
              VAT Returns<br />in <em style={{ color: 'var(--primary)' }}>Manchester</em>
            </h1>
            <p className="font-ui mb-8 max-w-2xl" style={{ color: 'var(--muted)', fontSize: '18px', lineHeight: 1.7 }}>
              Quarterly VAT returns prepared, reviewed, and filed on time for Manchester businesses. MTD-compliant. Flat rate scheme analysis included. You never touch HMRC.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="/quotation-calculator" className="btn-gold" style={{ minHeight: '48px', padding: '0 32px', lineHeight: '48px' }}>
                Get Your Manchester VAT Quote →
              </Link>
        ...
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="font-display mb-10" style={{ fontSize: 'clamp(26px,3.5vw,42px)', fontWeight: 400, color: 'var(--foreground)' }}>
              Transparent VAT pricing for Manchester
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              {[
                { tier: 'Standard', price: '£60', unit: '/month', desc: 'Quarterly VAT returns for Manchester businesses with straightforward transactions', features: ['Quarterly VAT return preparation', 'MTD-compliant submission', 'Flat rate scheme review', 'HMRC correspondence handled'] },
                { tier: 'Complex', price: '£90', unit: '/month', desc: 'Multiple income streams, international sales, or partial exemption', features: ['Everything in Standard', 'International VAT advice', 'Partial exemption calculations', 'VAT group management'] },
                { tier: 'Registration', price: '£299', unit: 'one-off', desc: 'New VAT registration with HMRC and scheme selection advice', features: ['VAT registration application', 'Scheme selection advice', 'First return preparation', 'MTD software setup'] },
              ].map((tier, i) => (
        ...
        <section className="px-6 md:px-10 py-16 md:py-20" style={{ borderBottom: '1px solid var(--gold-border)' }}>
          <div className="max-w-5xl mx-auto">
            ...
            <h2 className="font-display mb-10" style={{ fontSize: 'clamp(26px,3.5vw,42px)', fontWeight: 400, color: 'var(--foreground)' }}>
              Everything VAT for Manchester businesses
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { title: 'Flat Rate Scheme Analysis', desc: 'Annual review of whether the flat rate, standard, or cash accounting scheme saves your Manchester business the most tax.' },
                ...
                { title: 'International VAT', desc: 'Place of supply rules, reverse charge, import VAT, and EU OSS registration for Manchester digital businesses.' },
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                { label: 'Manchester Accounting', href: '/accounting/manchester' },
